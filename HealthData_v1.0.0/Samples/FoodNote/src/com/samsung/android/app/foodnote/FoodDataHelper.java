    ...
    private void insertFoodIntake(String foodName, float intakeCount, int mealType, long intakeTime, String Uuid) {
        ...
        switch (mealType) {
            case HealthConstants.FoodIntake.MEAL_TYPE_BREAKFAST:
                data.putLong(FoodIntake.START_TIME, intakeTime + AppConstants.BREAKFAST_TIME);
                break;
            case HealthConstants.FoodIntake.MEAL_TYPE_LUNCH:
                data.putLong(FoodIntake.START_TIME, intakeTime + AppConstants.LUNCH_TIME);
                break;
            case HealthConstants.FoodIntake.MEAL_TYPE_DINNER:
                data.putLong(FoodIntake.START_TIME, intakeTime + AppConstants.DINNER_TIME);
                break;
            case HealthConstants.FoodIntake.MEAL_TYPE_MORNING_SNACK:
                data.putLong(FoodIntake.START_TIME, intakeTime + AppConstants.MORNING_SNACK_TIME);
                break;
            case HealthConstants.FoodIntake.MEAL_TYPE_AFTERNOON_SNACK:
                data.putLong(FoodIntake.START_TIME, intakeTime + AppConstants.AFTERNOON_SNACK_TIME);
                break;
            case HealthConstants.FoodIntake.MEAL_TYPE_EVENING_SNACK:
                data.putLong(FoodIntake.START_TIME, intakeTime + AppConstants.EVENING_SNACK_TIME);
                break;
        }

        data.putLong(FoodIntake.TIME_OFFSET, timeOffset);
            ...
            try {
                ...
                while (c.moveToNext()) {
                    ...
                    if (packageName.equals("com.samsung.android.app.foodnote")) {
                        foodNameList.add(foodName + " : " + intakeTimes + " times" + " (" + intakeCalories + "kcals)");
                    } else {
                        foodNameList.add(foodName + " : " + intakeTimes + " times" + " (" + intakeCalories + "kcals)"
                                + " (Not Deletable)");
                    }
